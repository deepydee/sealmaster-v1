<div id="carousel" class="carousel slide" data-bs-ride="true">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="carousel-item overlay active">
        <img
          srcset="
            storage/img/slides/001-510x207.png 510w
            storage/img/slides/001-690x280.png 690w
            storage/img/slides/001-1110x547.png 1110w
          "
          src="storage/img/slides/001-1110x547.png"
          class="w-100 d-block"
          alt="First slide">
      ...
      <div class="carousel-item overlay">
        ...
        "
        src="storage/img/slides/002-1110x547.jpg"
        class="w-100 d-block"
        alt="First slide">
        <div class="carousel-caption">
          <div class="row">
      ...
      <div class="carousel-item overlay">
        <img
        srcset="
          storage/img/slides/003-510x207.jpg 510w
          storage/img/slides/003-690x280.jpg 690w
          storage/img/slides/003-1110x547.jpg 1110w
        "
        src="storage/img/slides/003-1110x547.jpg"
        class="w-100 d-block"
        alt="First slide">
        <div class="carousel-caption">
          <div class="row">
