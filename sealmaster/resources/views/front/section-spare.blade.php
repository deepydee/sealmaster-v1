...
<div class="row g-2 gx-md-4 gy-md-4">
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/John-Deer.svg" alt="John Deer logo">
        </div>
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/Claas.svg" alt="CLAAS logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/Komatsu.svg" alt="Komatsu logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/JCB.svg" alt="JCB logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/CAT.svg" alt="Caterpillar logo">
        </div>
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/Epiroc.svg" alt="Epiroc logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/Hitachi.svg" alt="Hitachi logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/Volvo.svg" alt="Volvo logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/Fuchs.svg" alt="Fuchs logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/Liebherr.svg" alt="Liebherr logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
    ...
    <div class="col-6 col-md-4 col-lg-3 col-xl-2">
      <div class="card card-brand card-wrapper">
        <div class="card-img-wrapper">
          <img class="card-img-top p-3" src="storage/img/logos/Terex.svg" alt="Terex logo">
        </div>
        <div class="card-body p-0 py-3 text-center">
