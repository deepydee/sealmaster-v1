<div>
    <x-slot:header>
        ...
        <x-breadcrumbs>
            ...
            <x-breadcrumbs.item>
                {{ $editing ? __('Edit post') : __('Create post') }}
            </x-breadcrumbs.item>
        </x-breadcrumbs>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input wire:model.lazy="post.title" id="title" class="block mt-1 w-full"
                                type="text" />
                        ...
                        <div x-cloak class="mb-4">
                            ...
                            <textarea wire:model.lazy="post.description" id="description"
                        ...
                        <div x-cloak class="mb-4">
                            ...
                            <div wire:ignore>
                                <x-ck-editor wire:model.lazy="post.content" data-content="@this" id="content"
                                    field="post.content" />
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <x-choices wire:model="tags" class="mt-1" id="tags" name="tags"
                        ...
                        <div class="mb-4">
                            ...
                            <select wire:model="post.user_id"
                                class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 mt-1">
                                <option value="">{{ __('Choose author') }}</option>
                                @foreach($listsForFields['users'] as $key => $value)
                                <option value="{{ $key }}" {{ $key==$post->user_id ? 'selected' : '' }}>{{ $value }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-6">
                            ...
                            <div
                                ...
                                <input wire:model="post.is_published" wire:click="toggleIsPublished()" type="checkbox"
